                ...
                <div id="home" class="tab-pane">
                    <div class="card-body">
                        <form class="form-horizontal gx-card" role="form" enctype="multipart/form-data" method="post" action="<?php echo e(route('sitesetting')); ?>">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="phone"><?php echo e(awtTrans('رقم الواتس')); ?> </label>
                                <div>
                                    <input required type="text" id="example-email" value="<?php echo e(settings('whatsapp')); ?>" name="whatsapp" class="form-control">
                                </div>
                            </div>
                                ...
                                <div class="form-group col-sm-6 col-md-6 mw-100">
                                    <div class="text-center">
                                        <div class="images-upload-block">
                                            ...
                                            <div class="upload-area">
                                                <div class="uploaded-block" data-count-order="0">
                                                    <img src="<?php echo e(url('public/images/users/default.png')); ?>">
                                                    <button class="close">×</button>
                                                </div>
                                            </div>
                                            <div class="upload-area"></div>
                                            <h5><?php echo e(awtTrans('صوره المستخدم')); ?></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\safari\resources\views/dashboard/settings/index.blade.php ENDPATH**/ ?>