<div id="menu" class="side-nav gx-sidebar">
    <div class="navbar-expand-lg">
        ...
        <a class="site-logo" href="<?php echo e(url('/admin')); ?>">
            <img src="<?php echo e(asset('/images/site/logo.png')); ?>" alt="Jumbo" title="Jumbo">
        </a>
...
<?php /**PATH /home/dashbaai/public_html/resources/views/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>