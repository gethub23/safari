                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="block_over_thing">
                                        <form action="<?php echo e(route('emailallusers')); ?>" method="POST" enctype="multipart/form-data" style="width: 100%;text-align: center;">
                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="mail" role="tabpanel" aria-labelledby="mail-tab">
                                    <div class="block_over_thing">
                                        <form action="<?php echo e(route('emailSingleUser')); ?>" method="POST" enctype="multipart/form-data" style="width: 100%;text-align: center;">
                                            <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dashbaai/public_html/resources/views/dashboard/users/index.blade.php ENDPATH**/ ?>