            ...
            <div class="modal-body">
                <form action="" method="post" autocomplete="off" enctype="multipart/form-data" id="edit_form">
                    ...
                    <div class="modal-footer border-0">
                        ...
                        <button type="submit"  class="btn text-primary card-link"><?php echo e(awtTrans('تعديلَ')); ?></button>
                    </div>
                </form>
            </div>
        </div>
    </div>
</div><?php /**PATH /home/ahmedtahaarabsde/public_html/dashboard_test/resources/views/dashboard/shared/components/editmodel.blade.php ENDPATH**/ ?>