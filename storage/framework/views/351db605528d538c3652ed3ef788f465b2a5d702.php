        ...
        $(document).on('submit','#delete_form',function(e){
            ...
            $.ajax({
                ...
                success: function( msg ) {
                    ...
                    $('#hide_on_delete_'+id).remove();

                    var rowCount = $('.tbody_class tr').length;
                    if(rowCount == 0){
                        $('.Block_Up').html('')
                        $('.Block_Up').append('<div class="Err_Block">')
                        $('.Block_Up').append('<img  src="<?php echo e(url('public/design/admin/images/no_found.png')); ?>">')
                        $('.Block_Up').append('</div>')
...
<?php $__env->stopSection(); ?><?php /**PATH /home/dashbaai/public_html/resources/views/dashboard/shared/components/scripts.blade.php ENDPATH**/ ?>