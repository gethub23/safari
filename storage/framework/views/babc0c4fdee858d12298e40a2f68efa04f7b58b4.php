        ...
        <div class="module-detail mail-detail block_email">
            <div class="module-list-scroll custom-scrollbar ps" style="position: relative; height: 621.055px;">
                ...
                <div class="mail-user-info width_100">
                    <img class="img_senter" alt="Alice Freeman" src="<?php echo e(url('public/images/users/'.$message->user->avatar)); ?>">
                    <div class="sender-name width_100">
                        <h4 class="send-to text-grey"><?php echo e($message->user->name); ?></h4>
                        <div class="flex_space width_100">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\safari\resources\views/dashboard/shared/ajax/contact_us/message_info.blade.php ENDPATH**/ ?>