    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?php echo e(awtTrans('هل تريد مواصلة عملية الحذف ؟')); ?></p>
...
<?php /**PATH /home/ahmedtahaarabsde/public_html/dashboard_test/resources/views/dashboard/shared/components/deletemodel.blade.php ENDPATH**/ ?>