...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->slot('EditModelContent'); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="field-2" class="control-label"><?php echo e(awtTrans('البريد الالكتروني')); ?></label>
                <input type="text" autocomplete="nope" name="email" required class="form-control" placeholder="aait@aait.sa">
            </div>
        </div>
