...
<?php $__env->startSection('content'); ?>
        ...
        <?php $__env->slot('AddModelContent'); ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" autocomplete="nope" name="name" required class="form-control" value="<?php echo e(old('provider_name')); ?>" placeholder="<?php echo e(awtTrans('اوامر الشبكة')); ?>">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
    ...
    <?php $__env->slot('EditModelContent'); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="field-1" class="control-label"><?php echo e(awtTrans('الاسم')); ?></label>
                <input type="text" autocomplete="nope" name="name" id="name" required class="form-control" value="<?php echo e(old('provider_name')); ?>" placeholder="<?php echo e(awtTrans('اوامر الشبكة')); ?>">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="field-2" class="control-label"><?php echo e(awtTrans('رقم الهاتف')); ?></label>
                <input type="text" autocomplete="nope" name="phone" id="phone" required class="form-control phone" placeholder="05011000000">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="field-2" class="control-label"><?php echo e(awtTrans('البريد الالكتروني')); ?></label>
                <input type="text"  id="email" autocomplete="nope" name="email" required class="form-control email" placeholder="aait@aait.sa">
            </div>
        </div>
    ...
    <?php $__env->slot('ShowModelContent'); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="field-2" class="control-label"><?php echo e(awtTrans('رقم الهاتف')); ?></label>
                <input type="text" autocomplete="nope" name="phone" id="" required class="form-control phone" placeholder="05011000000">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="field-2" class="control-label"><?php echo e(awtTrans('البريد الالكتروني')); ?></label>
                <input type="text"  id="" autocomplete="nope" name="email" required class="form-control email" placeholder="aait@aait.sa">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="field-3" class="control-label"><?php echo e(awtTrans('القسم')); ?></label>
                <select name="category_id" id="" required class="form-control category_id">
                    <option value><?php echo e(awtTrans('اختر القسم')); ?> </option>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/dashboard/providers/index.blade.php ENDPATH**/ ?>