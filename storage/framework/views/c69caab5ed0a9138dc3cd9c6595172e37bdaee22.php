...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('dashboard.shared.components.editmodel'); ?>
        <?php $__env->slot('EditModelContent'); ?>
            <div class="form-group col-sm-6 col-md-6 mw-100">
                <label for="field-1" class="control-label"> <?php echo e(awtTrans('الاسم بالعربيه')); ?></label>
                <input type="text" name="name_ar" id="name_ar" class="form-control"  placeholder="<?php echo e(awtTrans(' ادخل الاسم بالعربيه')); ?>" autocomplete="nope" required>
            </div>
            <div class="form-group col-sm-6 col-md-6 mw-100">
                <label for="field-1" class="control-label"> <?php echo e(awtTrans('الاسم بالانجليزيه')); ?></label>
                <input type="text" name="name_en" id="name_en" class="form-control"  placeholder="<?php echo e(awtTrans('ادخل الاسم بالانجليزيه')); ?>" autocomplete="nope" required>
            </div>
        <?php $__env->endSlot(); ?>
    <?php echo $__env->renderComponent(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dashbaai/public_html/resources/views/dashboard/cities/index.blade.php ENDPATH**/ ?>